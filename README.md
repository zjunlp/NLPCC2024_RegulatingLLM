...
- Detoxification Generalization Performance: Please use [this classifier](https://huggingface.co/zjunlp/DINM-Safety-Classifier) to assess whether the responses generated by the detoxified model for malicious inputs are safe.
...
- Side Effects: 
  ...
  - PIQA: commonsense reasoning task
...
The top 3 participating teams will be certificated by NLPCC and CCF-NLP. **Note that the top 3 results of participants will be verified multiple times by us.** If there is a significant gap between the results on the leaderboard and those verified by us, the next participant in line will be sequentially substituted into the top three positions.
