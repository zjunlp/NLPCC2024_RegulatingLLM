...
<table>
 ...
 > ❗️❗️If conducting experiments using an A80 GPU, calculating the MMLU metric takes around 12 hours, whereas other metrics only require approximately 2-3 hours.
