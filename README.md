...
<table>
 ...
 > ❗️❗️If conducting experiments using an A80 GPU, calculating the MMLU metric takes around 12 hours, while each of the other metrics only takes about 2 hours.
